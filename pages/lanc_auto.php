...
if (isset($_GET['cod_verificacao_fiscal'])) {
    ...
    if (isset($_POST['lavrarAuto'])) {
        
    $vencimentoAuto = $_POST['vencimento'];
    if($vencimentoAuto > $limiteMaximo){
        $vencimentoAuto = $limiteMaximo;
    }
        $dadosAuto = [
        ...
        Painel::lavrarAutoInfracao($dadosAuto);
...
<div class="create">
    <div class="box">
        ...
        <div class="container desc-auto">
            ...
            <textarea id="infrigencia" name="infrigencia"></textarea>
        </div>
...
<!--                    <div class="wrap-datas">
                        ...
                        <input type="date" id="aceite" name="aceite">
                    </div>-->
                    <div class="wrap-datas">
           ...
           <div class="totalizar">
                    ...
                    <div class="tot_auto">
                        <div class="total-container">
                            ...
                            <input type="hidden" id="totalAuto" name="totalAuto" value="<?php echo $totalAtualizado; ?>">
                            <input type="text" id="valor_total" name="valor_total" class="total" value="<?php echo $totalAtualizado;?>" readonly>
                        </div>  
                    </div>
            ...
            <div class="botao-salvar direita">
               ...
               <button id="lavrarAuto" name="lavrarAuto" type="submit">Lançar Auto</button>
